...
import type { SchoolData } from '@/context/AppProvider';
...
export default function DkmDetails({ data }: { data: SchoolData }) {
    ...
    const { hisense, datadik } = data;
    const imageList = hisense.images ? Object.values(hisense.images) : [];
    ...
    useEffect(() => {
        if (hisense && datadik) {
            ...
            newMismatches['Nama'] = !cleanAndCompare(hisense.schoolInfo.Nama, datadik.name);
            newMismatches['Alamat'] = !cleanAndCompare(hisense.schoolInfo.Alamat, datadik.address);
            newMismatches['Kecamatan'] = !cleanAndCompare(hisense.schoolInfo.Kecamatan, datadik.kecamatan);
            newMismatches['Kabupaten'] = !cleanAndCompare(hisense.schoolInfo.Kabupaten, datadik.kabupaten);
            newMismatches['PIC'] = !cleanAndCompare(hisense.schoolInfo.PIC, datadik.kepalaSekolah);
            ...
            <div className="w-full bg-white p-6 rounded-lg shadow-lg flex flex-col gap-4">
                <div className="flex flex-col gap-4">
                    <div className="grid grid-cols-12 gap-4">
                        <InfoField label="NPSN" value={hisense.schoolInfo.NPSN} colSpan="col-span-12 md:col-span-2" isMismatched={false} />
                        <InfoField label="Nama" value={hisense.schoolInfo.Nama} colSpan="col-span-12 md:col-span-4" isMismatched={!!mismatches['Nama']} />
                        <InfoField label="Alamat" value={hisense.schoolInfo.Alamat} colSpan="col-span-12 md:col-span-6" isMismatched={!!mismatches['Alamat']} />
                    </div>
                    <div className="grid grid-cols-12 gap-4">
                        <InfoField label="Provinsi" value={hisense.schoolInfo.Provinsi} colSpan="col-span-6 md:col-span-2" isMismatched={false} />
                        <InfoField label="Kabupaten" value={hisense.schoolInfo.Kabupaten} colSpan="col-span-6 md:col-span-2" isMismatched={!!mismatches['Kabupaten']} />
                        <InfoField label="Kecamatan" value={hisense.schoolInfo.Kecamatan} colSpan="col-span-6 md:col-span-2" isMismatched={!!mismatches['Kecamatan']} />
                        <InfoField label="Kelurahan/Desa" value={hisense.schoolInfo['Kelurahan/Desa']} colSpan="col-span-6 md:col-span-2" isMismatched={false} />
                        <InfoField label="Jenjang" value={hisense.schoolInfo.Jenjang} colSpan="col-span-4 md:col-span-1" isMismatched={false} />
                        <InfoField label="Bentuk" value={hisense.schoolInfo.Bentuk} colSpan="col-span-4 md:col-span-1" isMismatched={false} />
                        <InfoField label="Sekolah" value={hisense.schoolInfo.Sekolah} colSpan="col-span-4 md:col-span-1" isMismatched={false} />
                        <InfoField label="Formal" value={hisense.schoolInfo.Formal} colSpan="col-span-4 md:col-span-1" isMismatched={false} />
                    </div>
                    <div className="grid grid-cols-12 gap-4">
                        <InfoField label="PIC" value={hisense.schoolInfo.PIC} colSpan="col-span-6 md:col-span-2" isMismatched={!!mismatches['PIC']} />
                        <InfoField label="Telp" value={hisense.schoolInfo['Telp PIC']} colSpan="col-span-6 md:col-span-2" isMismatched={false} />
                        <InfoField label="Resi Pengiriman" value={hisense.schoolInfo['Resi Pengiriman']} colSpan="col-span-12 md:col-span-2" isMismatched={false} />
                        <InfoField label="Serial Number" value={hisense.schoolInfo['Serial Number']} colSpan="col-span-12 md:col-span-3" isMismatched={false} />
                        <InfoField label="Status" value={hisense.schoolInfo.Status} colSpan="col-span-12 md:col-span-3" isMismatched={false} />
                    </div>
                </div>
                <div>
                ...
                <div>
                    ...
                    {isDokumentasiOpen && (
                        ...
                        {Object.entries(hisense.images).map(([key, value], index) => (
